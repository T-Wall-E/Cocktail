...
if (strpos($_SERVER['PHP_SELF'],'index.php') === false && strpos($_SERVER['PHP_SELF'], 'register.php') === false && strpos($_SERVER['PHP_SELF'], 'impressum.php') === false && !(isset($_SESSION['user']) && $_SESSION['user'] != null && $_SESSION['user'] != "" && isset($_SESSION['UID'])))
{
